...
int main()
{
    u4byte key[4] = {0x00000000, 0x00000000, 0x00000000, 0x00000000};
    u4byte plain[4] = {0x00000000, 0x00000000, 0x00000000, 0x00000000};
    u4byte cipher[4] = {0x00000000, 0x00000000, 0x00000000, 0x00000000};
    u4byte *key_schedule;
    int i;

    key_schedule = set_key(key, 128);
